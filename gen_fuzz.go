...
func main(){
	// Example command: gen-fuzz -dir=./ -funcName=Add
	c := new(Context)
...
// 2. Automatically run go-fuzz on the generated file (need to go-fuzz-build first)
// [3. Automatically generate unit test from the inputs that made the function crush.]
